...
from .models import HandleAmounts, Product,Contact,Order,OrderUpdate,Image,Profile,MyOffers , Value_of_one_cash
    ...
    if request.method == "POST":
        ...
        if request.POST.get("online"):
            ...
            param_dict= {
                ...
                'WEBSITE':'WEBSTAGING',
                'CHANNEL_ID':'WEB',
            'CALLBACK_URL':'http://meridukaan.herokuapp.com/handlerequest/',
            }
...
def MyOrders(request):
    ...
    return render(request , 'shop/myorders1.html' , {'myorders':myorders , 'profile':profile})
